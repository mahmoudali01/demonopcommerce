...
Feature: user should be able to switch between currencies
  ...
  Scenario: new registered user could switch between currencies
    ...
    And enter first name "mahmoud" last name "ali" email "mahmoud@ali1.com" password "password" confirm pass "password"
    And press REGISTER
  ...
  Scenario: authenticated user could switch between currencies
    And user click on login button then enter email "mahmoud@ali1.com" password "password"
